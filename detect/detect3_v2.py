...
def Take_Photo(Position):
    ...
    cv2.waitKey(20)
    if Position == Int32(1):
        cv2.imwrite("/home/ucar/pic/Room_B/" + str(num) + ".jpg", frame)
    elif Position == Int32(2):
        cv2.imwrite("/home/ucar/pic/Room_C/" + str(num) + ".jpg", frame)
    elif Position == Int32(3):
        cv2.imwrite("/home/ucar/pic/Room_D/" + str(num) + ".jpg", frame)
    else:
        rospy.loginfo("error!")
    cap.release()
...
def parse_opt():
    global num
    #pic_source = '/home/ucar/pic/' + str(num) + '.jpg'
    pic_source = '/home/ucar/pic/'

    if num == 0:
        pic_source = '/home/ucar/xuefeng/'
    
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='/home/ucar/best.pt', help='model.pt path')
    parser.add_argument('--source', type=str, default=pic_source, help='source')  # file/folder, 0 for webcam
