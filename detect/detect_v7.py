...
weights_path = "/home/ucar/yolov5-v1.0/weights/cur_weights.pt"
...
def bo_bao(room_flag):
    ...
    if room_flag == 'room_B':
        if ans['B'] == 'kitchen':
            playsound("/home/ucar/WAV/B_kitchen.wav")
        elif ans['B'] == 'parlour':
        ...
        if ans['C'] == 'kitchen':
            playsound("/home/ucar/WAV/C_kitchen.wav")
        elif ans['C'] == 'parlour':
        ...
        if ans['D'] == 'kitchen':
            playsound("/home/ucar/WAV/D_kitchen.wav")
        elif ans['D'] == 'parlour':
